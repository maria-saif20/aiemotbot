...
ENV LANGCHAIN_PROJECT="BrainBot"

# # Set the GROQ API Key
# ENV GROQ_API_KEY="GROK_API_KEY"
...
CMD ["bash", "-c", "uvicorn main:app --host 0.0.0.0 --port 8000 & streamlit run BrainBot.py --server.port 8501"]